...
- 状态栏实时显示:`⛰️ 高峰 9:00-12:00 剩余1:32:30 · 缓存¥0.1 输入¥3 输出¥9`
- **每秒刷新**倒计时,精确到秒
- 颜色指示:高峰橙色 ⛰️ / 空闲绿色 🌙
- 点击弹出完整计价详情(北京时间、窗口规则、Flash/Pro 分档价格)

## 峰谷规则

DeepSeek 自 **2026-08-17** 起实行分档计价(北京时间):
...
- 价格为 2026-08-17 起生效的官方分档价,若官方调价需手动更新 `PRICES` 常量
